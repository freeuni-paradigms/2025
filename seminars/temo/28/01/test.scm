...
(display (if (equal? (digits 0) '(0)) "digits 1 SUCCESS" "digits 1 FAILURE"))(newline)
...
(display (if (equal? (ksubset 2 '(1 2 3)) '((1 2) (1 3) (2 3))) "ksubset 1 SUCCESS" "ksubset 1 FAILURE"))(newline)

(display (if (equal? (ksubset 2 '()) '()) "ksubset 2 SUCCESS" "ksubset 2 FAILURE"))(newline)
