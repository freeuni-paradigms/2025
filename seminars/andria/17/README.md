...
თითოეული ბაიტი აღწერს `x OP y` ტიპის გამოსახულებას, სადაც:
...
მაგალითად `11001000` აღწერს 6 + 2 გამოსახულებას, ხოლო `01001110` აღწერს 2 * 3 გამოსახულებას. მათი გაერთიანებით კი ვიღებთ: `11001000 01001110 00000000` == (6 + 2) + (2 * 3) = 14

# Compress (20 ქულა) (2023)
